...
class Model_Core_Commerce_Product extends \Orm\Model
{
    ...
    protected static $_properties = [
        ...
        'product_type', 'is_internal_service', 'unit_code', 'sat_product_service_code', 'sat_unit_code', 'sat_object_tax_code',
        'currency_code', 'price', 'cost', 'tax_code', 'sat_tax_code', 'sat_tax_factor_type', 'sat_tax_rate', 'stock_quantity', 'stock_reserved', 'stock_min',
