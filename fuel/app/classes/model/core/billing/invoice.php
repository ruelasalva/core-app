...
class Model_Core_Billing_Invoice extends \Orm\Model
{
    ...
    protected static $_properties = [
        'id', 'folio', 'invoice_type', 'party_id', 'cfdi_id', 'source_module', 'source_entity_type',
        'source_entity_id', 'issue_date', 'due_date', 'currency_code', 'exchange_rate', 'payment_term_id',
