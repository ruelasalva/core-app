...
class Model_Core_Commission_Config_CommercialPlan extends \Orm\Model
{
    protected static $_table_name = 'core_commission_config_commercial_plans';
    protected static $_primary_key = array('id');

    protected static $_properties = array(
        'id', 'code', 'name', 'description', 'status', 'owner_user_id',
