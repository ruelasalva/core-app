...
class Controller_Adminbase extends Controller_Template
{
    ...
    public function before()
    {
        ...
        $this->template->menu = [
            ...
            'web_conversion' => $this->is_super_admin || \Auth::has_access('web_conversion.access[view]'),
            ...
            'receivables' => $this->is_super_admin || \Auth::has_access('receivables.access[view]'),
            'payables' => $this->is_super_admin || \Auth::has_access('payables.access[view]'),
            'treasury' => $this->is_super_admin || \Auth::has_access('treasury.access[view]'),
            'budgets' => $this->is_super_admin || \Auth::has_access('budgets.access[view]'),
            'accounting' => $this->is_super_admin || \Auth::has_access('accounting.access[view]'),
            'accounting_chart' => $this->is_super_admin || \Auth::has_access('accounting.access[chart]'),
            'accounting_post' => $this->is_super_admin || \Auth::has_access('accounting.access[post]'),
            'accounting_periods' => $this->is_super_admin || \Auth::has_access('accounting.access[periods]'),
            'hr' => $this->is_super_admin || \Auth::has_access('hr.access[view]'),
            'purchases' => $this->is_super_admin || \Auth::has_access('purchases.access[view]'),
            'contracts' => $this->is_super_admin || \Auth::has_access('contracts.access[view]'),
            'billing' => $this->is_super_admin || \Auth::has_access('billing.access[view]'),
            'billing_stamp' => $this->is_super_admin || \Auth::has_access('billing.access[stamp]'),
            'billing_cancel' => $this->is_super_admin || \Auth::has_access('billing.access[cancel]'),
            'billing_rep' => $this->is_super_admin || \Auth::has_access('billing.access[rep]'),
            'business' => $this->is_super_admin || \Auth::has_access('business.access[view]'),
            'customer360' => $this->is_super_admin || \Auth::has_access('customers.access[view]') || \Auth::has_access('crm.access[view]') || \Auth::has_access('business.access[view]') || \Auth::has_access('parties.access[view]'),
            'supplier360' => $this->is_super_admin || \Auth::has_access('purchases.access[view]') || \Auth::has_access('suppliers.access[view]') || \Auth::has_access('business.access[view]') || \Auth::has_access('parties.access[view]'),
            'sales' => $this->is_super_admin || \Auth::has_access('sales.access[view]'),
            'commissions' => $this->is_super_admin || \Auth::has_access('commissions.access[view]'),
            'commission_config' => $this->is_super_admin || \Auth::has_access('commissions.access[view]'),
            ...
            'sat_download' => $this->is_super_admin || \Auth::has_access('sat.access[download]'),
            'sat_catalog_sync' => $this->is_super_admin || \Auth::has_access('sat.access[catalog_sync]'),
            'sat_credentials' => $this->is_super_admin || \Auth::has_access('sat.access[credentials]'),
            'cfdi' => $this->is_super_admin || \Auth::has_access('cfdi.access[view]'),
            'cfdi_audit' => $this->is_super_admin || \Auth::has_access('cfdi.access[audit]'),
            'fiscal' => $this->is_super_admin || \Auth::has_access('fiscal.access[view]'),
            'fiscal_ledger' => $this->is_super_admin || \Auth::has_access('fiscal.access[ledger]'),
            'fiscal_diot' => $this->is_super_admin || \Auth::has_access('fiscal.access[diot]'),
            'fiscal_iva' => $this->is_super_admin || \Auth::has_access('fiscal.access[iva]'),
            'fiscal_closing' => $this->is_super_admin || \Auth::has_access('fiscal.access[closing]'),
            ...
            'supplierimport' => $this->is_super_admin || \Auth::has_access('supplierimport.access[view]'),
            'parties' => $this->is_super_admin || \Auth::has_access('parties.access[view]'),
            'customers' => $this->is_super_admin || \Auth::has_access('customers.access[view]'),
