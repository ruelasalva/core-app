...
<style>
    ...
    .contract-description { white-space: pre-wrap; line-height: 1.6; }
                ...
                <div v-else>
                    ...
                    <div v-show="tab === 'general'">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="contract-description text-muted">{{ selected.description || 'Sin descripcion.' }}</div>
                        </div>
                        <div>
                            <div class="font-weight-bold mb-1">Notas</div>
                            <div class="contract-description text-muted">{{ selected.notes || 'Sin notas visibles.' }}</div>
                        </div>
                    </div>
