...
class Model_Core_Billing_Invoice_Item extends \Orm\Model
{
    ...
    protected static $_properties = [
        ...
        'sat_object_tax_code', 'unit_price', 'discount_amount', 'tax_code', 'tax_factor_type', 'tax_rate',
        'tax_amount', 'retention_amount', 'retention_tax_code', 'retention_rate', 'line_total', 'sort_order',
