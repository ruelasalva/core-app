...
/**
 * TAREA REPAIRREPTAXES
 *
 * Reconstruye impuestos REP faltantes desde XML SAT.
 *
 * No elimina registros existentes y no sobrescribe datos ya importados.
 *
 * Uso:
 * php oil refine repairreptaxes
 * php oil refine repairreptaxes --uuid=UUID_REP
 * php oil refine repairreptaxes --rfc=RFC --period=YYYY-MM
 */
class Repairreptaxes
{
    public function run()
    {
        ...
        try {
            ...
            \Log::error('[REPAIRREPTAXES] '.$e->getMessage());
    ...
    {
        \Cli::write('Reparacion de impuestos REP');
        ...
        \Cli::write(' - Filas faltantes insertadas: '.(int) \Arr::get($result, 'inserted', 0));
        \Cli::write(' - Filas ya existentes omitidas: '.(int) \Arr::get($result, 'skipped', 0));
